//
//  FavouritsTableViewController.m
//  For LoL
//
...
@implementation FavouritsTableViewController
...
- (void)viewDidLoad
{
    ...
    NSDictionary *favourits = [[NSUserDefaults standardUserDefaults] objectForKey:USER_KEY_FAVOURITS];
